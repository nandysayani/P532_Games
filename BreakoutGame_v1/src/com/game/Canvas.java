...
public class Canvas extends JPanel implements Observable,ActionListener, MouseMotionListener, MouseListener{
	...
	public Canvas(){
		...
		paddle = new Paddle((WIDTH/2)-(Paddle.P_WIDTH/2));// Center it
		...
		for(int i = 0; i < 2; ++i){
			ArrayList<BrickMain> temp = new ArrayList<BrickMain>();
				// 2 rows of brick...
			for(int j = 0; j < horizontalCount; ++j){ // layer of bricks.. 
				// Each brick constructor gets a x, y, life... adjacent brick 
				/**
				 * _____________   _____________    ______________
				 *|__0,2*20_____| |_1*60,2*20___|  |___3*60,2*20,__|
				 *
				 */
